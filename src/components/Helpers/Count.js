        ...
        {isLoading ? (
          ...
          <>
            <div className="flex items-center mt-2 mx-1 justify-center">
              <FontAwesomeIcon icon={titleIcon} className="h-6 w-6 text-purple-800 mr-1" />
              <h2 className="text-xl font-bold text-purple-600">{title}</h2>
            </div>
            <div className="flex items-center mt-2 mx-1 justify-center">
              <h4 className="text-lg font-bold rounded-sm shadow-md px-2 text-gray-600">{countValue}</h4>
